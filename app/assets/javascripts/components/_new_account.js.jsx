const NewAccount = (props) => {
  ...
  return(
    <form onSubmit={ (e) => { props.handleFormSubmit(formFields.routing_number.value, formFields.account_number.value, formFields.bank_address.value, formFields.bank_nickname.value); e.target.reset();}
}>
